...
namespace LKP_Frontend_MVC.Controllers.Login
{
    public class LoginController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> SSOLogin(TwoFactorAuthInputModel inputModel)
        {
            ...
            // This token is generated by Successfull Login in LKP Connect
            //string bearerKey = HttpContext.Session.GetString("token");
